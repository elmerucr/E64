...
E64::hud_t::hud_t(E64::blitter_ic *b)
{
	...
	// stats
	blitter->terminal_init(0, 0x1a, 0x00, 1, 1, 47, 8, AMBER_07, (AMBER_05 & 0x0fff) | 0x8000);
	blitter->terminal_clear(0);
	blitter->blit[0].set_x_pos(4);
	blitter->blit[0].set_y_pos(172);
	
	// notifications
	blitter->terminal_init(1, 0x1a, 0x00, 1, 1, 47, 6, AMBER_07, (AMBER_05 & 0x0fff) | 0x8000);
